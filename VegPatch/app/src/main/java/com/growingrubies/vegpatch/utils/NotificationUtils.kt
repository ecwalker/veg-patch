...
fun NotificationManager.sendNotification(context: Context, currentWeatherString: String) {
    ...
    val intent = WeatherDetailActivity.newIntent(context.applicationContext, currentWeatherString)
...
//    build the notification object with the data to be shown
    val notification = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID)
        ...
        .setContentTitle(Resources.getSystem().getString(R.string.notification_title))
        .setContentText(currentWeatherString)
